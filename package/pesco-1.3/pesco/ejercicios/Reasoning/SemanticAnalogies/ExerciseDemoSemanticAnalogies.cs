...
namespace pesco
{
    ...
    public partial class ExerciseDemoSemanticAnalogies : Gtk.Bin
      {
        const int WIDTH_SCREEN = 1000;
        const int HEIGHT_SCREEN = 600;
        SemanticAnalogiesExercise sae= null;
		...
		string [] animationsText = {"<span color='black'>¡Llegaste al ejercicio Asociación de Palabras!</span> Voy a mostrarte una frase, en la que tendrás que establecer una asociación entre dos palabras, busca la que falta y termina la frase.",
               /*1*/  "Cuando comiences el ejercicio, en la parte inferior de la pantalla verás las posibles soluciones, busca la que creas correcta y pulsa el botón <span color='black'>¡Listo!</span>",
               /*2*/ "¿Estás preparado para pensar? ¿Sí? ¡Pues vamos! Pulsa...<span color='black'> ¡Comenzar ejercicio!</span>"};
        ...
        public ExerciseDemoSemanticAnalogies(SemanticAnalogiesExercise ex)
        {
            this.Build ();
            this.sae = ex;
        ...
        public void InitPanel ()
        {
            ...
            backgroundPixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.reasoning.background15.png");
