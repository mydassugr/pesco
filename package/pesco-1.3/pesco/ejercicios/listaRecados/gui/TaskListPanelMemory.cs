...
namespace pesco
{
    ...
    public partial class TaskListPanelMemory : Gtk.Bin
    {
        Timer t;
        protected TaskListExercise padre;       
     ...
     //   public Gtk.Image GetImage {
      //      get { return image; }
       // }
        ...
        public TaskListExercise Padre {
            get {return this.padre;}
            set {padre = value;}
        }
               
        public TaskListPanelMemory (List<string> listaPalabras, int exposure) : this(listaPalabras, exposure, false)
        {
        }

        public TaskListPanelMemory (List<string> listaPalabras, int exposure, bool rojo)
        {
            this.Build ();
