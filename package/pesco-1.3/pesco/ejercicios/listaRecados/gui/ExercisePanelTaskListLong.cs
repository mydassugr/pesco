...
namespace pesco
{
    ...
    public partial class ExercisePanelTaskListLong : Gtk.Bin
    {
       ...
       string [] animationsText={"<span color='black'>                    Lista de Recados</span>\n" +
            ...
            "Debes selecccinar todos los recados de la última lista que memorizaste."+
            "\nCuando estés preparado para continuar el ejercicio pulsa<span color='black'> ¡Continuar Ejercicio!</span>"};
        ...
        public ExercisePanelTaskListLong ( TaskListExercise ex)
        {
            this.Build ();
            this.tle = ex;
