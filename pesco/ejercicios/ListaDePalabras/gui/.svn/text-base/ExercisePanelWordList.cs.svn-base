...
namespace pesco
{
    ...
    public partial class ExercisePanelWordList : Gtk.Bin
    {
   ...
   string [] animationsText={"<span color='black'>                    Lista de Palabras</span>\n" +
            "En este ejercicio, voy a mostrarte durante un minuto, una lista con 12 palabras, que tendrás que memorizar.",
            "Una vez transcurrido el tiempo, tendrás que decir en voz alta las palabras que recuerdes."+
            "\nNecesitarás un micrófono, si no lo tienes pídelo al dinamizador o tutor.",
            "Antes de comenzar el ejercicio vamos a comprobar si el micrófono funciona bien.\nCuando estés preparado para realizar la prueba, pulsa<span color='black'> ¡Comenzar prueba micrófono!</span>"};      
        ...
        public ExercisePanelWordList( WordListExercise ex)
        {
            this.Build ();
            this.wle = ex;
        ...
        void Expose_Event (object obj, ExposeEventArgs args)
        {
            ...
            if (currentStep == 0) {             
               ...
               //     auxPixbuf1 = Gdk.Pixbuf.LoadFromResource("pesco.ejercicios.LetrasYNumeros.blackboard.png");
                }
            ...
            // Explanation 1
                ...
                if ( FirstFrameStep() ) {
                    ...
                    stringToSay = animationsText[currentStep];
                    totalCharacters = animationsText[currentStep].Length;
               //     auxPixbuf1 = Gdk.Pixbuf.LoadFromResource("pesco.ejercicios.resources.img.numersvowels.backgroundnv2.png");
                }
                //IncrementCharacterDialog();
				PepeUtils.IncrementCharacterDialog(ref currentCharacter, ref pepeStatus, stringToSay );
                auxLayout.SetMarkup( "<span color=\"blue\">"+stringToSay.Substring(0, currentCharacter)+"</span>" );                
               //if ( AfterLastFrameStep() )
                //    imageBackground.Pixmap.DrawPixbuf( auxGC, auxPixbuf1, 0, 0, 350, 250, auxPixbuf1.Width, auxPixbuf1.Height,0 ,0, 0 );                
            }
