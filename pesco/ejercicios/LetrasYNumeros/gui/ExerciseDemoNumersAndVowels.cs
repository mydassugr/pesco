...
namespace pesco
{
    ...
    public partial class  ExerciseDemoNumersAndVowels: Gtk.Bin
    {
        const int WIDTH_SCREEN = 1000;
        const int HEIGHT_SCREEN = 600;
        NumbersAndVowelsExercise nve= null;
...
string [] animationsText={"<span color='black'>¡Dictado de Números y Vocales!</span> En este ejercicio, vamos a ver como está tu memoria. Te mostraré una pizarra con vocales y números que tendrás que memorizar.",
                /*1*/"Tienes que introducir, en primer lugar los números ordenados de menor a mayor y en segundo lugar, las vocales en orden alfabético.",
               /*2*/ "Vamos a realizar una prueba del ejercicio, para que ensayes. Cuando quieras, pulsa<span color='black'> ¡Comenzar prueba!</span>"};
        ...
        public  ExerciseDemoNumersAndVowels( NumbersAndVowelsExercise ex)
        {
            this.Build ();
            this.nve = ex;
        ...
        public void InitPanel ()
        {
            ...
            backgroundPixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.numersvowels.backgroundnv1.png");
            dialogPixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.numersvowels.dialognv.png");
            pepe1Pixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.numersvowels.pepenv1.gif");
            pepe2Pixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.numersvowels.pepenv2.gif");
