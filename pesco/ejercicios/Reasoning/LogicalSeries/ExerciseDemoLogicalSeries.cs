...
namespace pesco
{
	...
	public partial class ExerciseDemoLogicalSeries : Gtk.Bin
    {
		const int WIDTH_SCREEN = 1000;
        const int HEIGHT_SCREEN = 600;
		LogicalSeriesExercise lse= null;
  ...
  string [] animationsText={"<span color='black'>¡Ya estás en el ejercicio Completa la Serie!</span> En él te voy a mostrar una serie de dibujos que siguen una secuencia, debes completarla y añadir el siguiente. En la pizarra tienes un ejemplo.",
                /*1*/"Cuando comiences el ejercicio, en la parte inferior de la pantalla debes seleccionar la figura que creas correcta y pulsar el botón <span color='black'>¡Listo!</span> Si quieres una pista, pulsa el botón <span color='black'>Ayuda</span>.",
               /*2*/ "¿Estás relajado y la mente tranquila? ¿Sí? Pues cuando quieras pulsa<span color='black'> ¡Comenzar ejercicio!</span>"};
        ...
        public ExerciseDemoLogicalSeries(LogicalSeriesExercise ex)
        {
            this.Build ();
     		this.lse = ex;
        ...
        public void InitPanel ()
        {
            ...
            backgroundPixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.reasoning.background12.png");
        ...
        void Expose_Event (object obj, ExposeEventArgs args)
        {
            ...
            // Explanation 1
                ...
                if ( FirstFrameStep() ) {
                    ...
                    stringToSay = animationsText[currentStep];
                    totalCharacters = animationsText[currentStep].Length;
               //     auxPixbuf1 = Gdk.Pixbuf.LoadFromResource("pesco.ejercicios.resources.img.reasoning.screen12-1.png");
                }
				PepeUtils.IncrementCharacterDialog(ref currentCharacter, ref pepeStatus, stringToSay );
                auxLayout.SetMarkup( "<span color=\"blue\">"+stringToSay.Substring(0, currentCharacter)+"</span>" );                
            }
