...
namespace pesco
{
	...
	public partial class ExerciseDemoSemanticSeries : Gtk.Bin
	{
	   const int WIDTH_SCREEN = 1000;
       const int HEIGHT_SCREEN = 600;
       SemanticSeriesExercise sse = null;
        ...
        string [] animationsText = {"<span color='black'>¿Qué palabra sobra?</span>  En este ejercicio te voy a mostrar una serie de palabras, entre ellas hay una que no está relacionada con las demás. En la pizarra puedes ver un ejemplo.",
               /*1*/  "Cuando comiences el ejercicio, tendrás que seleccionar la palabra que no está relacionada y pulsar el botón <span color='black'>¡Listo!</span>",
               /*2*/  "¿Estás preparado? ¿Sí? Pues entonces pulsa...<span color='black'> ¡Comenzar Ejercicio!</span>"};
        ...
        public ExerciseDemoSemanticSeries (SemanticSeriesExercise ex)
        {
            this.Build ();
            this.sse = ex;
        ...
        public void InitPanel ()
        {
            ...
            backgroundPixbuf = Gdk.Pixbuf.LoadFromResource ("pesco.ejercicios.resources.img.reasoning.background11.png");
