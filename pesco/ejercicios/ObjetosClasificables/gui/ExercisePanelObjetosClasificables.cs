...
namespace pesco
{
	...
	public partial class ExercisePanelObjetosClasificables : Gtk.Bin
	{
       ...
       string [] animationsText={"<span color='black'>                    Memoriza las Imágenes</span>\n" +
            "En este ejercicio, verás durante un tiempo limitado, una serie de imágenes que tendrás que memorizar.",
			"Una vez transcurrido el tiempo, aparecerá otra pantalla con muchas imágenes, entre ellas, están las que has memorizado.",
			"Debes seleccionar las que recuerdes  pulsando sobre ellas."+
            "\nCuando estés preparado para realizar el ejercicio pulsa<span color='black'> ¡Comenzar Ejercicio!</span>"};
        ...
        public  ExercisePanelObjetosClasificables( EjercicioObjetosClasificables ex)
        {
            this.Build ();
            this.ocl = ex;
        ...
        public void InitPanel ()
        {
            ...
            imageBackground.ExposeEvent += Expose_Event;
         	backgroundPixbuf = new Gdk.Pixbuf(DirExer+"backgroundc2.png");
            dialogPixbuf = new Gdk.Pixbuf(DirExer+"dialogclasify.png");
            pepe1Pixbuf = new Gdk.Pixbuf(DirExer+"pepec1.png");
            pepe2Pixbuf = new Gdk.Pixbuf(DirExer+"pepec2.png");
