...
namespace pesco
{
	public partial class ExerciseDemoObjetosClasificables
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoObjetosClasificables
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExerciseDemoObjetosClasificables";
			// Container child pesco.ExerciseDemoObjetosClasificables.Gtk.Container+ContainerChild
			...
			w18.LabelProp = global::Mono.Unix.Catalog.GetString ("Comenzar prueba");
