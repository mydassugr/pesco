...
namespace pesco
{
	public partial class IntroductionDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.IntroductionDialog
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.IntroductionDialog";
			// Container child pesco.IntroductionDialog.Gtk.Container+ContainerChild
			...
			this.Hide ();
			this.buttonNext.Clicked += new global::System.EventHandler (this.buttonClicked);
		}
	}
}
