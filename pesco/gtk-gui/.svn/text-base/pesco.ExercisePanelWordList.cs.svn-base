...
namespace pesco
{
	public partial class ExercisePanelWordList
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExercisePanelWordList
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExercisePanelWordList";
			// Container child pesco.ExercisePanelWordList.Gtk.Container+ContainerChild
			...
			w18.LabelProp = global::Mono.Unix.Catalog.GetString ("Comenzar prueba micrófono");
