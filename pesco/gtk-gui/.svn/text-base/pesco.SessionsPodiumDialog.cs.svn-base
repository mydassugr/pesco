...
namespace pesco
{
	public partial class SessionsPodiumDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.SessionsPodiumDialog
			this.Name = "pesco.SessionsPodiumDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child pesco.SessionsPodiumDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child pesco.SessionsPodiumDialog.ActionArea
