...
namespace pesco
{
	public partial class PESCOGoodByeDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.PESCOGoodByeDialog
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.PESCOGoodByeDialog";
			// Container child pesco.PESCOGoodByeDialog.Gtk.Container+ContainerChild
			...
			w7.Pixbuf = global::Stetic.IconLoader.LoadIcon (this, "gtk-quit", global::Gtk.IconSize.Dnd);
			w6.Add (w7);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			global::Gtk.Label w9 = new global::Gtk.Label ();
			w9.LabelProp = global::Mono.Unix.Catalog.GetString ("_Salir");
			w9.UseUnderline = true;
			w6.Add (w9);
			w5.Add (w6);
			this.buttonQuit.Add (w5);
