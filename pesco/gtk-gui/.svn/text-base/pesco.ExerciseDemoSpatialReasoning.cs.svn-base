...
namespace pesco
{
	public partial class ExerciseDemoSpatialReasoning
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoSpatialReasoning
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExerciseDemoSpatialReasoning";
			// Container child pesco.ExerciseDemoSpatialReasoning.Gtk.Container+ContainerChild
