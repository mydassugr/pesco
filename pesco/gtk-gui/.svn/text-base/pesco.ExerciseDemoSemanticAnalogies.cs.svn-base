...
namespace pesco
{
	public partial class ExerciseDemoSemanticAnalogies
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoSemanticAnalogies
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExerciseDemoSemanticAnalogies";
			// Container child pesco.ExerciseDemoSemanticAnalogies.Gtk.Container+ContainerChild
