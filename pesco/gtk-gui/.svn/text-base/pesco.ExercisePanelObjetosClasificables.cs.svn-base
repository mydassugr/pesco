...
namespace pesco
{
	public partial class ExercisePanelObjetosClasificables
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExercisePanelObjetosClasificables
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExercisePanelObjetosClasificables";
			// Container child pesco.ExercisePanelObjetosClasificables.Gtk.Container+ContainerChild
