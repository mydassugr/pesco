...
namespace pesco
{
	public partial class ExerciseDemoLogicalSeries
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoLogicalSeries
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExerciseDemoLogicalSeries";
			// Container child pesco.ExerciseDemoLogicalSeries.Gtk.Container+ContainerChild
