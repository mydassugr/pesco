...
namespace pesco
{
	public partial class ExercisePanelTaskList
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExercisePanelTaskList
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExercisePanelTaskList";
			// Container child pesco.ExercisePanelTaskList.Gtk.Container+ContainerChild
