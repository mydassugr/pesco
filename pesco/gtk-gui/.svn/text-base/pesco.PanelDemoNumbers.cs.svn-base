...
namespace pesco
{
	public partial class PanelDemoNumbers
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.PanelDemoNumbers
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.PanelDemoNumbers";
			// Container child pesco.PanelDemoNumbers.Gtk.Container+ContainerChild
			...
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.alignment6]));
			w14.Position = 1;
			// Container child hbox2.Gtk.Box+BoxChild
			...
			w16.Add (w19);
			w15.Add (w16);
			this.buttonStartExercise.Add (w15);
			this.hbox2.Add (this.buttonStartExercise);
			global::Gtk.Box.BoxChild w23 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.buttonStartExercise]));
			w23.Position = 2;
			// Container child hbox2.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w44 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.alignment2]));
			w44.Position = 3;
			...
			global::Gtk.Box.BoxChild w46 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.alignment4]));
			w46.Position = 2;
			this.Add (this.vbox2);
			if ((this.Child != null)) {
				this.Child.ShowAll ();
			}
			this.buttonGoLast.Hide ();
			this.Hide ();
