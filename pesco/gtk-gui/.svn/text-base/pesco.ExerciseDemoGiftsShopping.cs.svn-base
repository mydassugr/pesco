...
namespace pesco
{
	public partial class ExerciseDemoGiftsShopping
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoGiftsShopping
			global::Stetic.BinContainer.Attach (this);
			this.Name = "pesco.ExerciseDemoGiftsShopping";
			// Container child pesco.ExerciseDemoGiftsShopping.Gtk.Container+ContainerChild
