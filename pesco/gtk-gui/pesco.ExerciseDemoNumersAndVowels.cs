...
namespace pesco
{
	public partial class ExerciseDemoNumersAndVowels
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.ExerciseDemoNumersAndVowels
			global::Stetic.BinContainer.Attach (this);
			this.WidthRequest = 1250;
			this.HeightRequest = 660;
			this.Name = "pesco.ExerciseDemoNumersAndVowels";
			// Container child pesco.ExerciseDemoNumersAndVowels.Gtk.Container+ContainerChild
