...
namespace pesco
{
	public partial class MaritalStatusPane
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget pesco.MaritalStatusPane
			global::Stetic.BinContainer.Attach (this);
			this.WidthRequest = 1200;
			this.HeightRequest = 600;
			this.Name = "pesco.MaritalStatusPane";
			// Container child pesco.MaritalStatusPane.Gtk.Container+ContainerChild
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString ("<b>¿Cuál es tu estado civil?</b>");
